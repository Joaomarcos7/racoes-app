...
import { DollarSign, ShoppingBag, Users, Truck, CheckCircle2, Store, Weight } from "lucide-react"
      ...
      {isLoading || !data ? (
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4">
            ...
            <KpiCard label="Peso Médio / Pedido" value={data.numeroPedidos > 0 ? `${(data.pesoVendido / data.numeroPedidos).toFixed(1)} kg` : "0 kg"} subtext={`em ${data.numeroPedidos} pedidos`} accentColor="#B45309" icon={Weight} />
          </div>
